            ...
            <div class="panel-body">
                <div class="tabbable">
                    ...
                    <div class="row" style="margin-bottom:30px">
                      ...
                      <div class="col-md-4">
                        <form action="monitoring_exe_ftahun.html" method="post">
                          <table border="0" rules="0">
                            <tr>
                              <td width="70">Pilih tahun</td>
                              <td width="20" align="center"> : </td>
                              <td width="100">
                                <select class="form-control" name="tahun" id="tahun" required>
                                  <?php
                                    $selected="";
                                    foreach ($tahun_monitoring as $tahun) {
                                      echo "<option value='".$tahun->tahun."' ".$selected."><b>".$tahun->tahun."</b> </option>";
                                      $selected="";
                                    }
                                    ?>
                                </select>
                    ...
                    <table class="table datatable-sorting" style="margin-bottom: 10px"  >
                      <thead align="center">   
                      <tr>
                        <td align="center"><b>No</b></td>
                        <td align="center"><b>Nama PJ Peminjam</b></td>
                        <td align="center"><b>No HP PJ</b></td>
                        ...
                        <td align="center"><b>Access by</b></td>
                      </tr>
                    </thead>
                      <tbody>
                        <?php
                        $start = 1;
                        foreach ($log_ruang as $data)
                        {
                            ?>
                            <tr>
