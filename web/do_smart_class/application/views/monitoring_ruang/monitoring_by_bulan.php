            ...
            <div class="panel-body">
                <div class="tabbable">
                    ...
                    <div class="row" style="margin-bottom:30px">
                      ...
                      <div class="col-md-4">
                        <form action="monitoring_by_hari.html" method="post">
                          <table border="0" rules="0">
                            <tr>
                              <td width="70">Pilih hari</td>
                              <td width="20" align="center"> : </td>
                              <td width="100">
                                <select class="form-control" name="hari" id="hari" required>
                                  <?php
                                    $selected="";
                                    foreach ($pilih_tanggal as $tgl) {
                                      echo "<option value='".$tgl->hari."' ".$selected."><b>".$tgl->hari."</b> </option>";
                                      $selected="";
                                    }
                                    ?>
                                </select>
                              ...
                              <td>
                                <input type="hidden" name="bulan" value=<?php echo $bulan_monitoring; ?>>
                              </td>
                    ...
                    <table class="table table-striped" style="margin-bottom: 10px" id="tabelflog1">
                      ...
                      <tbody>
                        <?php
                        $start = 1;
                        foreach ($data_log_bulanan as $data)
                        {
                            ?>
                           <tr>
