            ...
            <div class="panel-body">
                <div class="tabbable">
                    ...
                    <div class="row" style="margin-bottom:30px">
                      <div class="col-md-4">Bag 1</div>
                      <div class="col-md-4">
                        <form action="monitoring_exe_fbulan.html" method="post">
                      ...
                      <tbody>
                        ...
                        foreach ($data_log_tahunan as $value)
                        {
                            ...
                            <tr>
                               ...
                               <td><?php echo $value->NAMAKELAS; ?></td>
                               <td><?php echo $value->semester_rfid; ?></td>
                               <td><?php echo $value->NAMAMAKUL; ?></td>
                               <td>
                                <?php if($value->status_log == 1){
                                  echo "Masuk";
                                  }elseif ($value->status_log == 0) {
                                    echo "Keluar";
                                  } ?>
                               </td>
                               <td><?php echo $value->hari_log; ?></td>
                               <td><?php echo $value->jam_log ?></td>
                        </tr>
                        <?php
                    }
                    ?>
