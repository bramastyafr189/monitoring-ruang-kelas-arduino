        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h6 class="panel-title"><i class="icon-file-text"></i>
                  <?php
                    foreach ($log_manual_ruang as $value) {
                      $id_ruang   = $value->id_ruang_log_manual;
            ...
            <div class="panel-body">
                <div class="tabbable">
                    ...
                    <div class="row" style="margin-bottom:30px">
                      ...
                      <div class="col-md-4">
                        <form action="manual_exe_ftahun.html" method="post">
                            ...
                            <tr>
                              ...
                              <td width="100">
                                <select class="form-control" name="tahun" id="tahun" required>
                                  <?php
                                    $selected="";
                                    foreach ($tahun_monitoring_manual as $tahun) {
